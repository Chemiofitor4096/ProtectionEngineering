...
public class PEDataGen {
    ...
    private static void addExtraRegistrateData() {
        REGISTRATE.addDataGenerator(ProviderType.LANG, provider -> {
            ...
            add.accept("tooltip.protectionengineering.feature.sturdy_plate", "Armor +2 · DMG -10%");
            add.accept("tooltip.protectionengineering.feature.netherite_plate", "Armor +4 · DMG -15%");
            ...
            add.accept("tooltip.protectionengineering.feature.heavy_exoskeleton", "Armor +2 · Step up 1 · Fall -20%");
            ...
            add.accept("tooltip.protectionengineering.feature.cushioned_soles", "Fall DMG -20% · Height -1");
