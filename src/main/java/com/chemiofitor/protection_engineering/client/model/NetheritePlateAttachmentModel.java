...
public class NetheritePlateAttachmentModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("protectionengineering", "netherite_plate"), "main");
    private final ModelPart Plate;

    public NetheritePlateAttachmentModel(ModelPart root) {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer,
        ...
        Plate.render(poseStack, vertexConsumer, packedLight, packedOverlay, -1);
    }
}
