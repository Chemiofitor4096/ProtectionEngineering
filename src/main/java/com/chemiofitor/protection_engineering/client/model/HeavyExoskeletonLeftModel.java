...
public class HeavyExoskeletonLeftModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("protectionengineering", "heavy_exoskeleton_left"), "main");
    ...
    public HeavyExoskeletonLeftModel(ModelPart root) {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer,
        ...
        MachineLeg.render(poseStack, vertexConsumer, packedLight, packedOverlay, -1);
    }
}
